...
export const FEATURES: Feature[] = [
  // Core Features
  {
    ...
    notes: 'Main dashboard with workforce grid, action center, and gamification. Wired to Prisma DB.',
  },
  {
    id: 'companies-list',
    name: 'Companies List',
    ...
    dateAdded: '2026-01-27',
    healthStatus: 'healthy',
    notes: 'Companies listing with DE counts and status overview. Wired to Prisma DB.',
  },
  {
    id: 'companies-crud',
  ...
  // Support Features
  {
    ...
    dateAdded: '2026-01-27',
    healthStatus: 'healthy',
    notes: 'Support dashboard with live agents tab and scope lookup. Wired to Prisma DB.',
  },
  {
    id: 'scope-search',
    name: 'Scope Search',
    ...
    dateAdded: '2026-01-27',
    healthStatus: 'healthy',
    notes: 'Cross-DE scope search with classification filtering. Wired to Prisma DB.',
  },
  {
    id: 'runbook-viewer',
    name: 'Runbook Viewer',
  ...
  // View Templates (Priya)
  {
    ...
    notes: 'Filtered view showing at-risk and blocked DEs with severity sorting',
  },
  {
    ...
    owner: 'Priya',
    dependencies: ['portfolio-gantt'],
    notes: 'Resource load view per implementation lead with workload breakdown',
  },
