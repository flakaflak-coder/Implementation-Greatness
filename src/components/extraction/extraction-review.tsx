...
const TYPE_CONFIG: Record<string, { icon: React.ElementType; color: string; label: string }> = {
  ...
  KPI_TARGET: { icon: BarChart3, color: 'text-purple-500 bg-purple-50', label: 'KPI Target' },
  ...
  BUSINESS_RULE: { icon: Shield, color: 'text-indigo-500 bg-indigo-50', label: 'Business Rule' },
  ...
  API_ENDPOINT: { icon: Key, color: 'text-violet-500 bg-violet-50', label: 'API' },
