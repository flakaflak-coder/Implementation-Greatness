  ...
  return (
    <div
      className={cn(
        ...
        isCurrentWeek && 'bg-blue-50 text-blue-700',
...
function TimelineBar({
  ...
  if (barWidth <= 0) {
    return (
      <div className="h-8 relative flex items-center justify-center text-xs text-gray-400">
        Out of range
      </div>
    )
  }
  ...
  return (
    <div className="h-8 relative">
        ...
        {Array.from({ length: weeksToShow }).map((_, i) => (
          <div
            ...
            className={cn(
              ...
              i + startWeekOffset === currentWeek && 'bg-blue-50/50'
            )}
          />
        ))}
      </div>
      ...
      <div
        className={cn(
          'absolute top-1 bottom-1 rounded-md transition-all group cursor-pointer',
          statusConfig.bar,
      ...
      >
        ...
        {/* Drag handles */}
        <div className="absolute left-0 top-0 bottom-0 w-3 cursor-ew-resize opacity-0 group-hover:opacity-100 flex items-center justify-center">
          <GripVertical className="w-3 h-3 text-white/70" />
        </div>
        <div className="absolute right-0 top-0 bottom-0 w-3 cursor-ew-resize opacity-0 group-hover:opacity-100 flex items-center justify-center">
          <GripVertical className="w-3 h-3 text-white/70" />
        </div>
      </div>
      ...
      {goLivePercent !== null && (
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <div className="absolute -top-1 -left-1.5 w-3 h-3 bg-violet-600 rounded-full flex items-center justify-center">
